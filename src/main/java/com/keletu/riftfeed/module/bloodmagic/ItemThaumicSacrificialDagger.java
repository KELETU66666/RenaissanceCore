...
public class ItemThaumicSacrificialDagger extends Item implements IMeshProvider {

    public ItemThaumicSacrificialDagger() {
        this.setRegistryName("thaumic_sacrificial_dagger");
        this.setTranslationKey("thaumic_sacrificial_dagger");
    ...
    public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer player, EnumHand hand) {
        ...
        int lpAdded = (int) (ConfigHandler.values.sacrificialDaggerConversion * 2.5);
