...
public class RFBlocks {
    ...
    public static final Block quicksilver_crucible = new QuicksilverCrucibleBlock().setRegistryName("quicksilver_crucible").setTranslationKey("quicksilver_crucible").setCreativeTab(RenaissanceCore.tabRenaissanceCore);
