 ...
 */
public class FakeModelVoidFortressArmor extends ModelCustomArmor {
    ...
    public FakeModelVoidFortressArmor(float f) {
        super(f, 0, 128, 64);
    ...
    public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
        ...
        this.SideHornR1.isHidden = false;
        this.SideHornR2.isHidden = false;
        this.SideHornL1.isHidden = false;
        this.SideHornL2.isHidden = false;
        this.ShoulderplateRTop.isHidden = false;
        this.ShoulderplateRMid.isHidden = false;
        this.ShoulderplateR1.isHidden = false;
        this.ShoulderOrnamentR.isHidden = false;
        this.ShoulderOrnamentL.isHidden = false;
        this.ShoulderplateLTop.isHidden = false;
        this.ShoulderplateLMid.isHidden = false;
        ...
        this.FrontHornR1.isHidden = false;
        this.FrontHornR2.isHidden = false;
        this.FrontHornL1.isHidden = false;
        this.FrontHornL2.isHidden = false;
        ...
        this.HelmCordR.isHidden = false;
        this.HelmCordL.isHidden = false;
        this.ChestCordR.isHidden = false;
        this.ChestCordL.isHidden = false;
        this.BeltCord.isHidden = false;
        this.ArmBladeR1.isHidden = false;
        this.ArmBladeR2.isHidden = false;
        this.ArmBladeL1.isHidden = false;
        this.ArmBladeL2.isHidden = false;
