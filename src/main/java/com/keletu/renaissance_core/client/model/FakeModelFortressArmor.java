...
public class FakeModelFortressArmor extends ModelCustomArmor {
    ...
    public FakeModelFortressArmor(float f) {
        super(f, 0, 128, 64);
        textureWidth = 128;
        textureHeight = 64;
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        Goggles.isHidden = false;
        for (int a = 0; a < 3; ++a) {
            Mask[a].isHidden = true;
        }
        Scroll.isHidden = false;
        Book.isHidden = false;
        OrnamentL.isHidden = false;
        OrnamentL2.isHidden = false;
        OrnamentR.isHidden = false;
        OrnamentR2.isHidden = false;
        Gemornament.isHidden = false;
        Gem.isHidden = false;
        flapL.isHidden = false;
        flapR.isHidden = false;
        ShoulderplateLtop.isHidden = false;
        ShoulderplateL1.isHidden = false;
        ShoulderplateL2.isHidden = false;
        ShoulderplateL3.isHidden = false;
        ShoulderplateRtop.isHidden = false;
        ShoulderplateR1.isHidden = false;
        ShoulderplateR2.isHidden = false;
        ShoulderplateR3.isHidden = false;
        SidepanelR2.isHidden = false;
        SidepanelL2.isHidden = false;
        SidepanelR3.isHidden = false;
        SidepanelL3.isHidden = false;
    ...
    static {
        FakeModelFortressArmor.hasSet = new HashMap<Integer, Integer>();
        FakeModelFortressArmor.hasMask = new HashMap<Integer, Integer>();
        FakeModelFortressArmor.hasGoggles = new HashMap<Integer, Boolean>();
    }
}