...
public class ModelTaintSheep1 extends ModelQuadruped
{
    ...
    public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime)
    {
        ...
        this.head.rotationPointY = 6.0F + ((EntityTaintSheep)entitylivingbaseIn).getHeadRotationPointY(partialTickTime) * 9.0F;
        this.headRotationAngleX = ((EntityTaintSheep)entitylivingbaseIn).getHeadRotationAngleX(partialTickTime);
    }
