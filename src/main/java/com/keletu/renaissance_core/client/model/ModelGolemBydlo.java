...
public class ModelGolemBydlo extends ModelBase {
    ...
    public ModelGolemBydlo(boolean p) {
        float f1 = 0.0F;
    ...
    public void setRotationAngles(Entity en, float par1, float par2, float par3, float par4, float par5, float par6) {
            if(en.getLowestRidingEntity() == null){
    ...
    public void setLivingAnimations(EntityLivingBase par1EntityLiving, float par2, float par3, float par4) {
        EntityGolemBydlo var5 = null;
        int var6 = 0;
        int leftarm = 0;
        int rightarm = 0;
        if (par1EntityLiving instanceof EntityGolemBydlo) {
            var5 = (EntityGolemBydlo)par1EntityLiving;
