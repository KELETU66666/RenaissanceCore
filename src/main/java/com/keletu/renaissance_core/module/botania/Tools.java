...
public final class Tools {
    ...
    public static void renderTooManyFlowers(Minecraft mc, ScaledResolution res, int flowerNum, int max) {
        ...
        if (flowerNum > max) {
            ...
            String infoName = I18n.format("message.renaissance-core.botaniaaddon.manyflowers", String.format("%.1f", getOutputEfficiency(flowerNum, max) * 100));
