...
public class ItemBotanyDaggerOfSacrifice extends Item {
    public ItemBotanyDaggerOfSacrifice() {
        setRegistryName("botany_dagger_of_sacrifice");
        setTranslationKey("botany_dagger_of_sacrifice");
